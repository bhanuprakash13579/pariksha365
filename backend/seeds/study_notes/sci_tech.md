---
title: "Science & Technology — The Pariksha365 Complete Book"
subtitle: "A self-contained, exam-ready study guide for UPSC, SSC, RRB, Banking, PSU & State PSCs"
author: "Pariksha365"
date: "2026"
---
...
```mermaid
flowchart TD
    DOS[Department of Space<br/>Directly under PM]
    ISRO[ISRO — HQ Bengaluru]
    VSSC[VSSC Thiruvananthapuram<br/>Launch Vehicles]
    SDSC[SDSC Sriharikota<br/>Launch Port]
    URSC[U R Rao Satellite Centre<br/>Bengaluru — Satellites]
    LPSC[LPSC<br/>Liquid Propulsion]
    SAC[SAC Ahmedabad<br/>Applications + Payloads]
    NRSC[NRSC Hyderabad<br/>Remote Sensing]
    ISTRAC[ISTRAC<br/>Tracking Network]
...
```mermaid
flowchart LR
    S1[Stage 1<br/>PHWR<br/>Natural U-238 → Pu-239]
    S2[Stage 2<br/>FBR<br/>Pu-239 + U-238 / Th-232]
    S3[Stage 3<br/>Th-232 → U-233<br/>Thorium reactors]
    S1 --> S2 --> S3
```
...
flowchart TD
    U[User]
    A[Application software<br/>Browser, Office]
    O[Operating System<br/>Windows, Linux, Android, iOS]
    F[Firmware / BIOS]
    H[Hardware]
    U --> A --> O --> F --> H
```
