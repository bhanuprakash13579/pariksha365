---
title: "AAO — General Studies (Finance & Economics) Mastery Book"
subtitle: "SSC CGL Tier-2 Paper III — Assistant Audit Officer / Assistant Accounts Officer — One-stop, examiner-mindset, drill-heavy, 95%+ targeted"
author: "Pariksha365"
date: "2026"
---
...
<div class="mnemonic"><strong>Mnemonic — DEAD CLIC.</strong><br/><strong>D</strong>ebits = <strong>E</strong>xpenses + <strong>A</strong>ssets + <strong>D</strong>rawings<br/><strong>C</strong>redits = <strong>L</strong>iabilities + <strong>I</strong>ncome + <strong>C</strong>apital</div>
...
```mermaid
graph TD
  A[Source Documents<br/>vouchers, invoices, receipts] --> B[Journal<br/>book of original entry]
  B --> C[Ledger<br/>book of secondary entry]
  C --> D[Trial Balance]
  D --> E[Final Accounts<br/>Trading + P&L + Balance Sheet]
```
...
```mermaid
graph LR
  A[Trial Balance] --> B[Trading A/c<br/>→ Gross Profit/Loss]
  B --> C[Profit & Loss A/c<br/>→ Net Profit/Loss]
  C --> D[P&L Appropriation A/c<br/>→ for partnerships/companies]
  C --> E[Balance Sheet]
```
...
<div class="mnemonic"><strong>Universal rule.</strong> Every adjustment given <strong>outside</strong> the trial balance has a <strong>two-fold</strong> effect. If you record only one effect, your P&L and B/S will not tally.</div>
...
```mermaid
graph TD
  A[Budget] --> B[Revenue Account]
  A --> C[Capital Account]
  B --> B1[Revenue Receipts]
  B --> B2[Revenue Expenditure]
  C --> C1[Capital Receipts]
  C --> C2[Capital Expenditure]
  B1 --> B11[Tax Revenue]
  B1 --> B12[Non-Tax Revenue]
  C1 --> C11[Debt Capital Receipts]
  C1 --> C12[Non-debt Capital Receipts<br/>recovery of loans, disinvestment]
```
