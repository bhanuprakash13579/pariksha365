---
title: "Polity — The Complete Study Book"
subtitle: "Indian Constitution + Governance, exam-first, memory-first"
author: "Pariksha365"
version: "2026-04"
documentclass: book
---
...
```mermaid
timeline
    title Constituent Assembly — the chronology
    1946-12-09 : First session. Dr Sachchidananda Sinha in chair (as senior-most member).
    1946-12-11 : Rajendra Prasad elected permanent President.
    1946-12-13 : Nehru moves the "Objectives Resolution" — seed of the Preamble.
    1947-08-14 : Midnight session — Assembly becomes sovereign + dominion legislature.
    1949-11-26 : Constitution ADOPTED (date on every certificate of Constitution Day).
...
```mermaid
graph TD
    CA[Constituent Assembly<br/>389 ⇒ 299 members]
    CA --> DC[Drafting Committee<br/>Chair: B.R. AMBEDKAR]
    CA --> FR[Fundamental Rights<br/>Sub-committee<br/>Chair: J.B. KRIPALANI]
    CA --> UC[Union Powers<br/>Committee<br/>Chair: Nehru]
    CA --> US[Union Constitution<br/>Committee<br/>Chair: Nehru]
    CA --> PC[Provincial Constitution<br/>Committee<br/>Chair: Patel]
    CA --> MR[Minorities Committee<br/>Chair: Patel]
    CA --> SC[States Committee<br/>Chair: Nehru]
    CA --> RU[Rules of Procedure<br/>Chair: Rajendra Prasad]
    CA --> SP[Steering Committee<br/>Chair: Rajendra Prasad]
    CA --> BR[B.N. RAU<br/>Constitutional Adviser<br/>NOT a member]
```
...
graph TD
    P[Preamble]
    P --> S1[SOVEREIGN<br/>not subject to any external power]
    P --> S2[SOCIALIST<br/>added 1976<br/>democratic socialism — mixed economy]
    P --> S3[SECULAR<br/>added 1976<br/>state has no religion; equal respect for all]
    P --> S4[DEMOCRATIC<br/>representative + participatory + adult franchise]
    P --> S5[REPUBLIC<br/>head of state elected, not hereditary]
    P --> J[JUSTICE<br/>social + economic + political — Russian ideal]
    P --> L[LIBERTY<br/>thought, expression, belief, faith, worship — French ideal]
    P --> E[EQUALITY<br/>status + opportunity]
    P --> F[FRATERNITY<br/>dignity of individual + unity + integrity of nation]
```
...
```mermaid
graph TD
    C[Constitution<br/>~448 Articles, 25 Parts, 12 Schedules]
    C --> P1[Part I<br/>Union + its territory<br/>Arts 1–4]
    C --> P2[Part II<br/>Citizenship<br/>Arts 5–11]
    C --> P3[Part III<br/>FRs<br/>Arts 12–35]
    C --> P4[Part IV<br/>DPSPs<br/>Arts 36–51]
    C --> P4A[Part IV-A<br/>FDs<br/>Art 51-A]
    C --> P5[Part V<br/>The Union<br/>Arts 52–151]
    C --> P6[Part VI<br/>The States<br/>Arts 152–237]
    C --> P8[Part VIII<br/>Union Territories<br/>Arts 239–242]
    C --> P9[Part IX<br/>Panchayats<br/>Arts 243–243-O]
    C --> P9A[Part IX-A<br/>Municipalities<br/>Arts 243-P–243-ZG]
    C --> P9B[Part IX-B<br/>Cooperatives<br/>Arts 243-ZH–243-ZT]
    C --> P11[Part XI<br/>Centre-State rel.<br/>Arts 245–263]
    C --> P12[Part XII<br/>Finance + Property<br/>Arts 264–300-A]
    C --> P14A[Part XIV-A<br/>Tribunals<br/>Arts 323-A + B]
    C --> P17[Part XVII<br/>Official Language<br/>Arts 343–351]
    C --> P18[Part XVIII<br/>Emergency<br/>Arts 352–360]
    C --> P20[Part XX<br/>Amendment<br/>Art 368]
    C --> P21[Part XXI<br/>Special Provisions<br/>Arts 369–392]
    C --> P22[Part XXII<br/>Short title + commencement<br/>Arts 393–395]
```
  ...
  root((Foundation))
    Chapter 1 Making of the Constitution
      ...
      Sources
        ...
        Ireland DPSPs
    Chapter 2 Preamble
      13 Dec 1946 Objectives Resolution
      42nd Amdt added S S I
      Kesavananda 1973 part of Const
      Berubari 1960 not part
    Chapter 3 Salient features
      Lengthiest written
      Quasi-federal
      Parliamentary UK
      Universal franchise 61st Amdt
    Chapter 4 Map
      25 Parts
      12 Schedules
      Memory palace of the house
```
...
graph TD
    ...
    W --> HC[Habeas Corpus<br/>produce the body]
    W --> M[Mandamus<br/>we command]
    W --> P[Prohibition<br/>stop, higher to lower]
    W --> C[Certiorari<br/>certify, quash lower order]
    W --> Q[Quo Warranto<br/>by what authority?]
```
...
```mermaid
graph TD
    DP[DPSPs<br/>Arts 36-51]
    DP --> S[Socialistic<br/>Arts 38, 39, 39A, 41, 42, 43, 43A, 46, 47]
    DP --> G[Gandhian<br/>Arts 40, 43, 43-B, 46, 47, 48]
    DP --> L[Liberal-Intellectual<br/>Arts 44, 45, 48, 48A, 49, 50, 51]
```
...
```mermaid
graph LR
    C[Citizen-state compact]
    C --> F[FRs<br/>Part III<br/>What the state must NOT do]
    C --> D[DPSPs<br/>Part IV<br/>What the state SHOULD do]
    C --> Du[FDs<br/>Part IV-A<br/>What the citizen MUST do]
```
...
```mermaid
timeline
    title India's Constitutional Journey
    1773 : Regulating Act — first British governance statute for India.
    1858 : Crown takes over from East India Company.
    1909 : Morley-Minto — separate electorates for Muslims.
    1919 : Montagu-Chelmsford — diarchy in provinces.
    1935 : Government of India Act — 2/3 of our Constitution's machinery.
    1946 : Cabinet Mission plan; Constituent Assembly's first session 9 Dec.
    1947 : 15 Aug — Independence.
    1949 : 26 Nov — Constitution ADOPTED.
    1950 : 26 Jan — Constitution INTO FORCE. Republic Day.
    1951 : 1st Amendment — Art 15(4) + 9th Schedule.
    1976 : 42nd Amendment — "mini-Constitution" under Emergency; FDs added.
    1978 : 44th Amendment — Property right dropped; Arts 20 + 21 non-suspendable.
    1985 : 52nd Amendment — Anti-defection.
    1992 : 73rd + 74th — Panchayats + Municipalities.
    2002 : 86th — Art 21A RTE.
    2011 : 97th — Cooperatives.
    2019 : 103rd — EWS 10%.
    2019 : Abrogation of Art 370 — J&K + Ladakh UTs.
    2023 : 106th — Women's reservation in legislatures (post-delimitation).
```
