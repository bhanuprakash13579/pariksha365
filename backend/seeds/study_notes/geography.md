---
title: "Geography — The Complete Study Book"
subtitle: "Physical + Indian + World + Human + Economic, exam-first, memory-first"
author: "Pariksha365"
version: "2026-04"
documentclass: book
---
...
graph LR
    S[Sun]
    S --> M1[Mercury<br/>0.39 AU<br/>no moon<br/>smallest]
    M1 --> V[Venus<br/>0.72 AU<br/>no moon<br/>hottest]
    V --> E[Earth<br/>1 AU<br/>1 moon<br/>only life]
    E --> M2[Mars<br/>1.52 AU<br/>2 moons<br/>red planet]
    M2 --> J[Jupiter<br/>5.2 AU<br/>95 moons<br/>largest]
    J --> Sa[Saturn<br/>9.58 AU<br/>146 moons<br/>rings]
    Sa --> U[Uranus<br/>19.2 AU<br/>27 moons<br/>tilted 98°]
    U --> N[Neptune<br/>30 AU<br/>14 moons<br/>windiest]
```
...
graph TD
    E[Earth]
    E --> C[Crust<br/>5-70 km<br/>solid<br/>silicate rocks]
    E --> M[Mantle<br/>70-2900 km<br/>solid-plastic<br/>peridotite]
    E --> OC[Outer Core<br/>2900-5150 km<br/>liquid<br/>Fe + Ni; drives magnetic field]
    E --> IC[Inner Core<br/>5150-6371 km<br/>solid<br/>Fe + Ni]
```
...
```mermaid
graph LR
    I[Igneous<br/>from magma/lava] --> S[Sedimentary<br/>from deposition + compaction]
    S --> M[Metamorphic<br/>from heat + pressure]
    M --> I
```
...
graph TD
    PB[Plate boundaries]
    PB --> Con[Convergent<br/>plates collide]
    PB --> Div[Divergent<br/>plates move apart]
    PB --> Tra[Transform<br/>plates slide past]
    Con --> O1[Ocean-Ocean<br/>deep trench + island arc<br/>e.g., Aleutians]
    Con --> OC[Ocean-Continent<br/>subduction + Andes]
    Con --> CC[Continent-Continent<br/>Himalayas]
    Div --> MOR[Mid-ocean ridge<br/>Mid-Atlantic Ridge]
    Div --> Rift[Continental rift<br/>East African Rift]
    Tra --> SAF[San Andreas Fault]
```
...
graph TD
    A[Atmosphere]
    A --> T[Troposphere<br/>0-12 km<br/>75 percent mass<br/>weather]
    A --> S[Stratosphere<br/>12-50 km<br/>ozone layer 20-35 km<br/>stable, planes fly]
    A --> M[Mesosphere<br/>50-85 km<br/>coldest<br/>meteors burn up]
    A --> Th[Thermosphere<br/>85-600 km<br/>aurora<br/>ISS at 400 km]
    A --> Ex[Exosphere<br/>600-10000 km<br/>merges with space]
```
...
graph TB
    N[North Pole]
    N --> PC1[Polar Easterlies 60-90°N]
    PC1 --> F1[Polar Front 60°N]
    F1 --> W1[Westerlies 30-60°N]
    W1 --> HL1[Horse Latitudes 30°N]
    HL1 --> T1[Trade Winds NE 0-30°N]
    T1 --> ITCZ[ITCZ 0° equator]
    ITCZ --> T2[Trade Winds SE 0-30°S]
    T2 --> HL2[Horse Latitudes 30°S]
    HL2 --> W2[Westerlies 30-60°S]
    W2 --> F2[Polar Front 60°S]
    F2 --> PC2[Polar Easterlies]
    PC2 --> S[South Pole]
```
...
graph LR
    I[Indian Ocean]
    I -- moisture --> K[strikes Kerala coast<br/>~1 June]
    K --> A[Arabian Sea branch]
    K --> B[Bay of Bengal branch]
    A --> WG[Western Ghats<br/>heavy rain windward]
    A --> DE[Deccan Plateau<br/>rain shadow]
    B --> NE[Arakan coast → Assam]
    B --> Ga[Ganga plain<br/>west-travelling]
    A --> Pu[Punjab by late June]
    B --> Pu
```
...
```mermaid
graph TD
    I[India physiography]
    I --> H[1 Himalayas<br/>Northern Mountains]
    I --> N[2 Northern Plains<br/>Indo-Gangetic-Brahmaputra]
    I --> P[3 Peninsular Plateau<br/>Deccan + Central Highlands]
    I --> D[4 Coastal Plains<br/>Eastern + Western]
    I --> Is[5 Islands<br/>Lakshadweep + Andaman-Nicobar]
    I --> De[6 Desert<br/>Thar]
```
...
graph TD
    R[Indian rivers]
    R --> H[Himalayan perennial]
    R --> P[Peninsular seasonal]
    H --> I[Indus system]
    H --> G[Ganga system]
    H --> Br[Brahmaputra system]
    P --> E[East-flowing to Bay of Bengal]
    P --> W[West-flowing to Arabian Sea]
    I --> Iin[Indus + Jhelum + Chenab + Ravi + Beas + Sutlej<br/>Indus Waters Treaty 1960]
    G --> Gin[Ganga + Yamuna + Ghaghara + Gandak + Kosi + Chambal]
    Br --> Brin[Brahmaputra = Tsangpo → Dihang → Siang → Brahmaputra → Jamuna]
    E --> EE[Mahanadi + Godavari + Krishna + Kaveri]
    W --> WW[Narmada + Tapi + Mahi + Sabarmati + Luni]
```
...
```mermaid
graph LR
    W[Cold Season<br/>Dec-Feb] --> H[Hot Season<br/>Mar-May]
    H --> SW[SW Monsoon<br/>Jun-Sep]
    SW --> Re[Retreating Monsoon<br/>Oct-Nov]
    Re --> W
```
...
graph TD
    ...
    B --> Tu[Tundra — polar]
    B --> Ta[Taiga — coniferous forest — Russia, Canada]
    B --> TM[Temperate Forests]
    B --> TMG[Temperate Grasslands — Prairies USA, Steppes Russia, Pampas Argentina, Veld S Africa, Downs Australia]
    B --> Me[Mediterranean — olives, citrus]
    B --> TF[Tropical Forests]
    B --> TG[Tropical Grasslands — Savanna Africa, Campos Brazil, Llanos Venezuela]
